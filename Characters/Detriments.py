...
current_page = 'Detriments'
sub_pages = ['Combat','Survival','Social','Academic']
...
print('<body>')
constructor.generate_tabs(['Introduction','Social-Ladder','Backgrounds','Skills-and-Traits','Perks','Detriments','Promotion'],5)

print('<main><div id=content>')
with open(current_page+'.txt','r') as file:
	constructor.generate_article('Whats in a Detriment',file.read())
