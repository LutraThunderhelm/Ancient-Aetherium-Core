...
current_page = 'Combat'
sub_pages = ['Turns and Order','Actions','Fight Starters','Attacking']
...
constructor.establish_head('Combat Rules',current_page)
print('<header>')
constructor.generate_nav(2)
constructor.generate_header('Combat','Bang. Pow.')
print('</header>')

print('<body>')
constructor.generate_tabs(['Introduction','Situational','Navigation','Statuses','Invention','Alchemy','Combat','Damage','Railways-and-Chases'],6)

print('<main><div id=content>')
with open(current_page+'.txt','r') as file:
	constructor.generate_article('Combat and You',file.read())
