...
current_page = 'Invention'
sub_pages = ['Plans','Parts','Production','Premade']
...
constructor.establish_head('Invention Rules',current_page)
print('<header>')
constructor.generate_nav(2)
constructor.generate_header('Invetion','Tools at the Ready')
print('</header>')

print('<body>')
constructor.generate_tabs(['Introduction','Situational','Navigation','Statuses','Invention','Alchemy','Combat','Damage','Railways-and-Chases'],4)

print('<main><div id=content>')
with open(current_page+'.txt','r') as file:
	constructor.generate_article('The four Ps of Invention',file.read())
