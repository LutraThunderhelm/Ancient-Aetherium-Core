...
current_page = 'Firing-Weapons'
sub_pages = ['Crossbow','Ballista','Rifle','Ruckster','Boomstick']
...
constructor.establish_head('Gear | Firing Weapons',current_page)
print('<header>')
constructor.generate_nav(3)
constructor.generate_header('Firing Weapons','Death from afar')
print('</header>')

print('<body>')
constructor.generate_tabs(['Introduction','Brawling-Weapons','Firing-Weapons','Attire','Kits','Husks'],2)

print('<main><div id=content>')
with open(current_page+'.txt','r') as file:
	constructor.generate_article('What is a Firing Weapon?',file.read())
